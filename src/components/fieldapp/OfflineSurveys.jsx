import { Download, Trash2, CheckCircle2, HardDrive, RefreshCw, Target } from "lucide-react";
...
export default function OfflineSurveys({ surveys, offlineSurveys, onDownload, onRemove, totalStorageBytes, isOnline, onSelect, onRefresh, loadingSurveys, myInterviewCounts, getEffectiveLimit }) {
